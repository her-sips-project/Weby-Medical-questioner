...
// import AddImage from "../../image_area/add-image/AddImage";
import HomePage from "../../HomeArea/HomePage/HomePage";
// import HomePageCopy from "../../HomeArea/HomePageCopy/HomePageCopy";
import HomePageMain from "../../HomeArea/HomePage/homePageMain";
...
function RoutingHeb(langProps: RoutingHebProps): JSX.Element {
  return (
    <>
      <Routes>
        <Route path="/" element={<HomePageMain lang={langProps.language} />} />
        ...
        <Route
          path="/male-or-femalePageWithHeb"
          element={<MaleOrFemalePageWithHeb />}
        />
        {/* --------------------english---------------------------------------------------------------------------------------------------------- */}
        ...
        <Route
          path="/QuestionThreeForMale"
          element={<QuestionThreeForMale />}
        />
        ...
        <Route
          path="/QuestionSevenForMale"
          element={<QuestionSevenForMale />}
        />
        <Route
          path="/QuestionEightForMale"
          element={<QuestionEightForMale />}
        />
        <Route path="/QuestionNineForMale" element={<QuestionNineForMale />} />
        <Route path="/QuestionTenForMale" element={<QuestionTenForMale />} />
        <Route
          path="/ResulOfQuestionsMale"
          element={<ResultsPagesInEn />}
        />
        <Route
          path="/ResulOfQuestionsFemal"
          element={<ResultsPagesInEn />}
        />
