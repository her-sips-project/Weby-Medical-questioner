...
function QuestionTenWithHebHelp(): JSX.Element {
    ...
    const customRoutes = "/QuestionTen";
    useLanguageNavigationToEn(customRoutes);
  

    const signsOfPaint = {...store.getState().PainsAppState.signsOFPain};
    const title ="לפניך מוצגות שתי תמונות המייצגות חוויה של מידת החרדה שלך מאכילה. יש לבחור בתמונה הנכונה עבורך"
    ...
    return (
        ...
        <div className="MaleOrFemalePageWithHeb  px-0 container  h-75">
          <div className="mainImgs  h-100">
            <div className="imgL w-50 m-3  ">
              <img
                ...
                onClick={
                  badlyHappenClickHandlerOnQuestionTenWithHebHelpForFemaleImage
                }
              />
            </div>
            <div className="imgR w-50 m-3 ">
              <img
                ...
                onClick={
                  wellHappenClickHandlerOnQuestionTenWithHebHelpForFemaleImage
                }
              />
              <br />
            </div>
          ...
          <div className="bottomPage">
            <BtnsBottom
              descriptions={title}
              clickBack={() => navigate("/QuestionNineWithHebHelp")}
