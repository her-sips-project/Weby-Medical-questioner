...
function QuestionSix(): JSX.Element {
  ...
  const title =
    "There are two images representing experiences regarding choking while eating.Choose the image that best represents your experience.";
        ...
        <div className="mainImgs  h-100">
          <div className="imgL w-50 m-3  h-80">
            <img
              ...
              onClick={badlyHappenClickHandlerOnQuestionSixForFemaleImage}
            />
          </div>
          <div className="imgR w-50 m-3  h-80">
            <img
              ...
              onClick={wellHappenClickHandlerOnQuestionSixForFemaleImage}
            />
            <br />
          </div>
        </div>
