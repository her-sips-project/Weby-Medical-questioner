...
import ImageQuestionFive1 from "./../../../../../Assets/Images/imagesForFemalesQuetion/Picture9.jpg";
import ImageQuestionFive2 from "./../../../../../Assets/Images/imagesForFemalesQuetion/Picture10.jpg";
...
function QuestionFive(): JSX.Element {
  ...
  function badlyHappenClickHandlerOnQuestionFiveForFemaleImage(): void {
    if (signsOfPaint.losingWeight === true) {
      ...
      <div className="MaleOrFemalePageWithHeb  px-0 container  h-75">
        <div className="mainImgs qNum5  h-100">
          <div className="imgL w-50 m-3  h-80">
            <img
              ...
              src={ImageQuestionFive1}
              onClick={badlyHappenClickHandlerOnQuestionFiveForFemaleImage}
            />
          </div>
          <div className="imgR w-50 m-3  h-80">
            <img
              ...
              src={ImageQuestionFive2}
              onClick={wellHappenClickHandlerOnQuestionFiveForFemaleImage}
            />
          </div>
        </div>
        ...
        <div className="bottomPage">
          <BtnsBottom
            ...
            clickNext={() => navigate("/QuestionSix")}
          />
        </div>
      </div>
    </div>
  ...
  //          <div>
  //         <img src={ImageQuestionFive1} onClick={badlyHappenClickHandlerOnQuestionFiveForFemaleImage}/>
  //         <br/>
  //         <Link to={"/QuestionFour"} title="BACK"><label>
  //         <PossibilityOfBackTothetweenQuestions/>
  //         </label></Link>

  //         <Link to={"/QuestionSix"} title="NEXT"><label>
  //         <PossibilityOfNextTothetweenQuestions/>
  //         </label></Link>
  //        </div>
  //        <div>
  //        <img src={ImageQuestionFive2}  onClick={wellHappenClickHandlerOnQuestionFiveForFemaleImage}/>
  //        <br/>
  //        <Link to={""} title="There are two images representing experiences regarding your body weight. Choose the image that best represents your experience."><label>
  //        <svg className="SvgQuestionFive Box"  width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
