...
import ImageQuestionOne1 from   "./../../../../../Assets/Images/imagesForFemalesQuetion/Picture1.gif";
import ImageQuestionOne2 from   "./../../../../../Assets/Images/imagesForFemalesQuetion/Picture2.gif";
...
function QuestionOne():JSX.Element {
 ...
 function  badlyHappenClickHandlerOnQuestionOneForFemaleImage():void{
        if(signsOfPaint.difficultySwallowingLiquids === true ){
            if(signsOfPaint.numberOfSignsOfPain !== undefined ){
    ...
    return (
        ...
        <div> 
        <img src={ImageQuestionOne1} onClick={badlyHappenClickHandlerOnQuestionOneForFemaleImage}/>
        <br/>
        <Link to={"/MaleOrFemalePage"} title="BACK"><label>
        <PossibilityOfBackTothetweenQuestions/>
        </label></Link>
        <Link to={"/QuestionTwo"} title="NEXT"><label>
        <PossibilityOfNextTothetweenQuestions/>
        </label></Link>
        </div>
        <div>
          <img src={ImageQuestionOne2}  onClick={wellHappenClickHandlerOnQuestionOneForFemaleImage}/>
          <br/>
          <Link to={""} title="There are two images representing experiences while drinking liquids. Choose the image that best represents your experience.">
