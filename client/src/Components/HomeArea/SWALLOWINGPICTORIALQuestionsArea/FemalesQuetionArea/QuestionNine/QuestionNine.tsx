...
import ImageQuestionNine1 from "./../../../../../Assets/Images/imagesForFemalesQuetion/Picture17.jpg";
import ImageQuestionNine2 from "./../../../../../Assets/Images/imagesForFemalesQuetion/Picture18.jpg";
...
function QuestionNine(): JSX.Element {
  const navigate = useNavigate();
  const signsOfPaint = { ...store.getState().PainsAppState.signsOFPain };
  const customRoutes = "/QuestionNineWithHebHelp";
  useLanguageNavigationToHeb(customRoutes);

  const title =
    "There are two images representing experiences of enjoying mealtime.Choose the image that best represents your experience.";

  function wellHappenClickHandlerOnQuestionNineForFemaleImage(): void {
  ...
  function badlyHappenClickHandlerOnQuestionNineForFemaleImage(): void {
    if (signsOfPaint.EnjoyingMeals === true) {
      ...
      <div className="MaleOrFemalePageWithHeb  px-0 container  h-75">
        ...
        <div className="bottomPage">
          <BtnsBottom
            ...
            clickNext={() => navigate("/QuestionTen")}
          />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="QuestionNine">
      <div>
        ...
        />
        <br />
        <Link to={"/QuestionEight"} title="BACK">
          <label>
            <PossibilityOfBackTothetweenQuestions />
          </label>
        </Link>
        <Link to={"/QuestionTen"} title="NEXT">
          <label>
      ...
      <div>
        ...
        <Link
          to={""}
          title="There are two images representing experiences of enjoying mealtime.Choose the image that best represents your experience."
        >
          <label>
            <svg
              className="SvgQuestionNine Box"
              width="16"
              height="16"
              fill="currentColor"
              viewBox="0 0 16 16"
