        ...
        <div className="mainImgs  h-100">
          <div className="imgL w-50 m-3  h-80">
            <img
              ...
              onClick={badlyHappenClickHandlerOnQuestionTenForFemaleImage}
            />
          </div>
          <div className="imgR w-50 m-3  h-80">
            <img
              ...
              onClick={wellHappenClickHandlerOnQuestionTenForFemaleImage}
            />
            <br />
          </div>
        </div>
  ...
  return (
    <div className="QuestionTen">
      <div>
        ...
        />
        <br />
        <Link to={"/QuestionNine"} title="BACK">
          <label>
            <PossibilityOfBackTothetweenQuestions />
          </label>
        </Link>
        <Link to={"/ResultOFAllQuestionsAndAnswers"} title="NEXT">
          <label>
