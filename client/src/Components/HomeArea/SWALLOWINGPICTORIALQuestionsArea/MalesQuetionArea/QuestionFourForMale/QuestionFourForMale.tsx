        ...
        <div className="mainImgs  h-100">
          <div className="imgL w-50 m-3  h-80">
            <img
              ...
              onClick={badlyHappenClickHandlerOnQuestionFourForMaleImage}
            />
          </div>
          <div className="imgR w-50 m-3  h-80">
            <img
              ...
              onClick={wellHappenClickHandlerOnQuestionFourForMaleImage}
            />
            <br />
          </div>
        </div>
  ...
  return (
    <div className="QuestionFourForMale">
      <div>
        ...
        />
        <br />
        <Link to={"/QuestionThreeForMale"} title="BACK">
          <label>
            <PossibilityOfBackTothetweenQuestions />
          </label>
        </Link>
        <Link to={"/QuestionFiveForMale"} title="NEXT">
          <label>
      ...
      <div>
        ...
        <Link
          to={""}
          title="There are two images representing experiences of coughing while eating.Choose the image that best represents your experience."
        >
          <label>
            <svg
              className="SvgQuestionFourForMale Box"
              width="16"
              height="16"
              fill="currentColor"
              viewBox="0 0 16 16"
