...
function QuestionSixForMale(): JSX.Element {
    ...
    return (
        <div className="QuestionSixForMale">
        <div> 
         <img src={ imageQuestionSixForMale1} onClick={badlyHappenClickHandlerOnQuestionSixForMaleImage}/> 
        <Link to={"/QuestionFiveForMale"} title="BACK"><label>
            <PossibilityOfBackTothetweenQuestions/>
        </label></Link>
        <Link to={"/QuestionSevenForMale"} title="NEXT"><label>
            <PossibilityOfNextTothetweenQuestions/>
            </label></Link>
        </div>
        <div>
            <img src={ imageQuestionSixForMale2} onClick={wellHappenClickHandlerOnQuestionSixForMaleImage}/>
            <br/>
             <Link to={""} title="There are two images representing experiences regarding choking while eating.Choose the image that best represents your experience."><label>
             <svg className="SvgQuestionSixForMale Box"  width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
