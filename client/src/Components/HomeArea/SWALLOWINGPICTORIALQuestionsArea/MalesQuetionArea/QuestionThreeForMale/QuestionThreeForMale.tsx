        ...
        <div className="mainImgs  h-100">
          <div className="imgL w-50 m-3  h-80">
            <img
              ...
              onClick={badlyHappenClickHandlerOnQuestionTwoForMaleForMaleImage}
            />
          </div>
          <div className="imgR w-50 m-3  h-80">
            <img
              ...
              onClick={wellHappenClickHandlerOnQuestionThreeForMaleForMaleImage}
            />
            <br />
          </div>
        </div>
  ...
  return (
    <div className="QuestionThreeForMale">
      <div>
        ...
        />
        <br />
        <Link to={"/QuestionTwoForMale"} title="BACK">
          <label>
            <PossibilityOfBackTothetweenQuestions />
          </label>
        </Link>

        <Link to={"/QuestionFourForMale"} title="NEXT">
          <label>
      ...
      <div>
        ...
        <Link
          to={""}
          title="There are two images representing experiences while swallowing pills.Choose the image that best represents your experience."
        >
          <label>
            <svg
              className="SvgQuestionThreeForMale Box"
              width="16"
              height="16"
              fill="currentColor"
              viewBox="0 0 16 16"
