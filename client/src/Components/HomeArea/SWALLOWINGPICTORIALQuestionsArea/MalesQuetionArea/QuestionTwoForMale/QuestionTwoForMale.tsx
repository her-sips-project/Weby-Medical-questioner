...
function QuestionTwoForMale(): JSX.Element {
  ...
  const customRoutes = "/QuestionTowForMaleWithHebHelp";
      ...
      <div className="MaleOrFemalePageWithHeb  px-0 container  h-75">
        <div className="mainImgs  h-100">
          ...
          <div className="imgR w-50 m-3  h-75">
            <img
              ...
              src={imageQuestionTwoForMale2}
              onClick={wellHappenClickHandlerOnQuestionTwoForMaleForMaleImage}
            />
            <br />
          </div>
        </div>
        ...
        <div className="bottomPage">
          <BtnsBottom
            ...
            clickNext={() => navigate("/QuestionThreeForMale")}
          />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="QuestionTwoForMale">
      <div>
        ...
        />
        <br />
        <Link to={"/question-one-for-Male"} title="BACK">
          <label>
            <PossibilityOfBackTothetweenQuestions />
          </label>
        </Link>
        <Link to={"/QuestionThreeForMale"} title="NEXT">
          <label>
      ...
      <div>
        ...
        <br />
        <Link
          to={"/HelpSentenceToQuestionTwo"}
          title="There are two images representing experiences while swallowing solid foods.Choose the image that best represents your experience. "
        >
          <label>
            <svg
              className="SvgQuestionTwoForMale Box"
              width="16"
              height="16"
              fill="currentColor"
              viewBox="0 0 16 16"
