...
function QuestionFiveForMaleWithHebHelp(): JSX.Element {
    ...
    const title =" לפניך מוצגות שתי תמונות לגבי משקל הגוף שלך. יש לבחור בתמונה הנכונה עבורך "   
...
//     return (
//         <div className="QuestionFiveForMaleWithHebHelp">
//         <div>
//         <img src={imageQuestionFiveForMaleWithHebHelp1} onClick={ badlyHappenClickHandlerOnQuestionFiveForMaleWithHebHelpImage}/>
//         <br/>
//         <Link to={"/QuestionFourForMaleWithHebHelp"}title="חזור">
//         <PossibilityOfBackTothetweenQuestions/>
//         </Link>
//         <Link to={'/QuestionSixForMaleWithHebHelp'} title="הבא">
//         <PossibilityOfNextTothetweenQuestions/>
//         </Link>
//         </div>
//         <div>
//         <img src={imageQuestionFiveForMaleWithHebHelp2} onClick={wellHappenClickHandlerOnQuestionFiveForMaleWithHebHelpImage}/>
//             <br/>
//             <Link to={""} title="
//   לפניך מוצגות שתי תמונות לגבי משקל הגוף שלך. 
