      ...
      <div className="MaleOrFemalePageWithHeb  px-0 container  h-75">
        ...
        <div className="bottomPage">
          <BtnsBottom
            ...
            clickNext={() => navigate("/QuestionSevenForMaleWithHebHelp")}
          />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="QuestionSixForMaleWithHebHelp">
      <div>
        <img
          src={imageQuestionSixForMaleWithHebHelp1}
          onClick={badlyHappenClickHandlerOnQuestionSixForMaleWithHebHelpImage}
        />
        <br />
      ...
      <div>
        <img
          src={imageQuestionSixForMaleWithHebHelp2}
          onClick={wellHappenClickHandlerOnQuestionSixForMaleWithHebHelpImage}
        />
        <br />
        <Link
          to={""}
