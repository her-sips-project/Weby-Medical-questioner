import "./QuestionEightForMale.css";
import imageQuestionEightForMale1 from "./../../../../../Assets/Images/imagesForMalesQuetion/Picture15.gif";
import imageQuestionEightForMale2 from "./../../../../../Assets/Images/imagesForMalesQuetion/Picture16.gif";
...
function QuestionEightForMale(): JSX.Element {
  const navigate = useNavigate();
  const signsOfPaint = { ...store.getState().PainsAppState.signsOFPain };

  const customRoutes = "/QuestionEightForMaleWithHebHelp";
  ...
  function wellHappenClickHandlerOnQuestionEightForMaleForMaleImage(): void {
  ...
  function badlyHappenClickHandlerOnQuestionEightForMaleForMaleImage(): void {
      ...
      <div className="MaleOrFemalePageWithHeb  px-0 container  h-75">
        ...
        <div className="bottomPage">
          <BtnsBottom
            ...
            clickNext={() => navigate("/QuestionNineForMale")}
          />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="QuestionEightForMale">
      <div>
        <img
          src={imageQuestionEightForMale1}
          onClick={badlyHappenClickHandlerOnQuestionEightForMaleForMaleImage}
        />
        <br />
        <Link to={"/QuestionSevenForMale"} title="BACK">
          <label>
            <PossibilityOfBackTothetweenQuestions />
          </label>
        </Link>

        <Link to={"/QuestionNineForMale"} title="NEXT">
          <label>
      ...
      <div>
        ...
        <Link
          to={""}
          title="
             There are two images representing experiences of pain when swallowing. 
             Choose the image that best represents your experience.              
             "
        >
          <label>
            <svg
              className="SvgQuestionSevenForMale Box"
              width="16"
              height="16"
              fill="currentColor"
              viewBox="0 0 16 16"
...
export default QuestionEightForMale;
