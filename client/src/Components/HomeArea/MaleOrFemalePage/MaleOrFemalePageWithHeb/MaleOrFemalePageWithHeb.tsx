...
import femalePageWithHeb from "./../../../../Assets/Images/MaleOrFemale/Female/Picture2.gif";
import MalePageWithHeb from "./../../../../Assets/Images/MaleOrFemale/Male/Picture.jpg";
import signsOfPainsStateService from "../../../../Services/SignsOfPainsAppStateServic/Signs-of-pains-app-state-servic";
import "./MaleOrFemalePageWithHeb.css";
...
function MaleOrFemalePageWithHeb(): JSX.Element {
  const navigate = useNavigate();
  const [signsOfPaintDetail, setPatientDetail] = useState<Patient>();
  const title = "לפניך מוצגות שתי תמונות של מגדרים. בחר את המגדר שמייצג אותך";

  function clickHandlerOnFemaleImageHeb(): void {
      ...
      <div className="MaleOrFemalePageWithHeb  px-0 container  h-75">
        <div className="mainImgs  h-100">
          ...
          <div className="imgR w-50 m-3  h-80">
            <img
              ...
              onClick={clickHandlerOnFemaleImageHeb}
            />
            <br />
          </div>
        </div>
        ...
        <div className="bottomPage">
          ...
          >
            <label>
              <svg
                className="SvgMaleOrFemalePage Box"
                width="16"
                height="16"
                fill="currentColor"
                viewBox="0 0 16 16"
...
export default MaleOrFemalePageWithHeb;
